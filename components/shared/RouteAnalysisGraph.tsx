  ...
  return (
    <div className="flex flex-col gap-2">
      <button
        ...
        className="ui-control flex items-center gap-1.5 self-start px-3 py-1.5 text-xs"
      >
        ...
        Analysis
        <svg className={cn("h-3 w-3 transition", showAnalysis && "rotate-180")} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
