...
export default function MetadataBottomSheet({
  ...
  const requiredMissing = !location.state.trim() || !location.area.trim() || !location.route.trim();
  const confirmDisabled = action === "upload" ? s3Loading || requiredMissing : false;
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-xs font-semibold text-fg-secondary">
            Location{" "}
            {action === "upload" && <span className="font-normal text-fg-muted">(required)</span>}
          </p>
          <ComboInput
            label="State / Region"
        ...
        <div className="flex flex-col gap-2">
          <p className="text-xs font-semibold text-fg-secondary">
            Details <span className="text-fg-muted font-normal">(optional)</span>
          </p>
          <input
            type="text"
