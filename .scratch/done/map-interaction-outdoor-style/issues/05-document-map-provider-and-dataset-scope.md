...
- `.scratch/done/map-interaction-outdoor-style/issues/03-add-outdoor-basemap-with-fallback.md`
- `.scratch/done/map-interaction-outdoor-style/issues/04-keep-climbing-overlay-fast-and-bounded.md`
