...
> Scope source: `.scratch/done/map-interaction-outdoor-style/PRD.md` and issues 01-05 in this folder.
...
Issue: `.scratch/done/map-interaction-outdoor-style/issues/01-stabilize-route-map-interaction-contract.md`
...
Issue: `.scratch/done/map-interaction-outdoor-style/issues/02-align-profile-map-viewport-policy.md`
...
Issue: `.scratch/done/map-interaction-outdoor-style/issues/03-add-outdoor-basemap-with-fallback.md`
...
Issue: `.scratch/done/map-interaction-outdoor-style/issues/04-keep-climbing-overlay-fast-and-bounded.md`
...
Issue: `.scratch/done/map-interaction-outdoor-style/issues/05-document-map-provider-and-dataset-scope.md`
