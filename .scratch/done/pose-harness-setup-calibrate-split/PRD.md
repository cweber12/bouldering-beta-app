...
`.scratch/done/pose-calibration-analyze-split/PRD.md` (established the three-artifact model and the
Analyze step); `.scratch/done/pose-batch-reseed-stale-truth/` (the ReseedSweeper pattern this
...
- The `.scratch/done/pose-calibration-analyze-split/issues/06` video-identity direction stays
