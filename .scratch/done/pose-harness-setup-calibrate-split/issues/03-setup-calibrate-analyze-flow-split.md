...
- `.scratch/done/pose-harness-setup-calibrate-split/issues/01-seed-tap-off-hash.md`
- `.scratch/done/pose-harness-setup-calibrate-split/issues/02-vitpose-seed-region.md`
