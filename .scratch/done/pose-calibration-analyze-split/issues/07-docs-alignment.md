...
- `.scratch/done/pose-calibration-analyze-split/issues/01-uniform-grid-calibration.md`
- `.scratch/done/pose-calibration-analyze-split/issues/02-video-keyed-ground-truth.md`
- `.scratch/done/pose-calibration-analyze-split/issues/03-analyze-action-production-run.md`
- `.scratch/done/pose-calibration-analyze-split/issues/04-scoring-vs-ground-truth.md`
- `.scratch/done/pose-calibration-analyze-split/issues/05-batch-analyze-gt-gate.md`
