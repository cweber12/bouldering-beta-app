...
- 2026-07-18: closed wontfix. Before this doc was written, the analyzer repo
  sent the opposite handoff (`.scratch/done/pose-calibration-freshness/`, harness issue
