...
- `.scratch/calibration-flag-review/issues/03-readonly-reviewer-accept.md`
- `.scratch/calibration-flag-review/issues/04-vitpose-hard-requirement.md`
- `.scratch/calibration-flag-review/issues/05-review-affordances.md`
- `.scratch/calibration-flag-review/issues/06-labels-into-scan-setup.md`
