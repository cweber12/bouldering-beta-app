...
The analyzer tuning-suggestion loop is a separate deferred backlog concern and is tracked in `.scratch/parked/pose-analyzer-tuning-suggestion-loop/PRD.md`. It is not part of this cross-program data-contract reconciliation.
