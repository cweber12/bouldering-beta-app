...
Status: wontfix
Superseded-by: .scratch/done/pose-calibration-analyze-split/issues/05-batch-analyze-gt-gate.md
Type: AFK
...
- `.scratch/actionable/pose-ground-truth-detection-eval/issues/08-headless-scoring-pass.md`
