...
Status: wontfix
Superseded-by: .scratch/done/pose-calibration-analyze-split/issues/04-scoring-vs-ground-truth.md
Type: AFK
...
- `.scratch/actionable/pose-ground-truth-detection-eval/issues/03-ground-truth-model-persistence.md`
- `.scratch/actionable/pose-ground-truth-detection-eval/issues/05-ground-truth-frame-states-occlusion.md`
- `.scratch/actionable/pose-ground-truth-detection-eval/issues/07-calibration-flow-split.md`
