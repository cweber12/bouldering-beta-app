...
function DemoPreview() {
  ...
  return (
    <div className="w-full max-w-sm overflow-hidden rounded-xl border border-zinc-700 bg-zinc-900 shadow-xl">
      <div className="flex items-center justify-between border-b border-zinc-800 bg-zinc-950 px-3 py-1.5">
        <span className="text-xs font-mono text-zinc-500">route-photo.jpg</span>
      ...
      <div className="flex items-center gap-2 border-t border-zinc-800 bg-zinc-950 px-3 py-1.5">
        ...
        <span className="w-8 text-right text-xs font-mono text-zinc-600">{pct}%</span>
      </div>
    </div>
  );
}
  ...
  return (
    <main className="flex flex-1 flex-col items-center gap-16 px-6 py-16">
      <div className="flex flex-col items-center gap-4 text-center max-w-lg">
        <div className="mb-1 inline-flex items-center gap-2 rounded-full border border-zinc-700 bg-zinc-900 px-3 py-1 text-xs font-medium text-zinc-400">
      ...
      <div className="flex flex-col items-center gap-3">
        <p className="text-xs text-zinc-600 uppercase tracking-wider">Live demo</p>
        <DemoPreview />
      ...
      <div className="w-full max-w-2xl">
        <p className="mb-6 text-center text-xs text-zinc-600 uppercase tracking-wider">
          How it works
        </p>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {[
            ...
            <div
              key={step}
              className="rounded-xl border border-zinc-800 bg-zinc-900 px-5 py-5 flex flex-col gap-2"
            >
              <div className="flex h-7 w-7 items-center justify-center rounded-full border border-zinc-700 text-xs font-bold text-zinc-400">
                {step}
              </div>
