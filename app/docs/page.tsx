  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-10">
      <div className="prose prose-invert prose-zinc max-w-none">
        ...
        <section className="mt-10">
          ...
          <ol className="mt-4 flex flex-col gap-3 pl-5 list-decimal text-zinc-400 leading-relaxed">
            <li>
              ...
              <span className="font-mono text-zinc-300">MoveNet</span> — 17 keypoints, or{" "}
              <span className="font-mono text-zinc-300">MediaPipe Pose Landmarker</span> — 33 keypoints)
        ...
        {/* ---------------------------------------------------------------- */}
        <section className="mt-10 mb-12">
          <h2 className="text-xl font-semibold text-zinc-200">Licensing &amp; attribution</h2>
          <div className="mt-4 overflow-hidden rounded-xl border border-zinc-800">
            <table className="w-full text-sm text-left text-zinc-400">
              <thead className="border-b border-zinc-800 bg-zinc-900">
                <tr>
                  ...
                  <th className="px-4 py-3 font-medium text-zinc-300">Copyright</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-800">
                <tr>
                  ...
                  <td className="px-4 py-3 font-mono text-xs text-zinc-300">Apache 2.0</td>
