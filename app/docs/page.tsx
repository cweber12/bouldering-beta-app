  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-10">
      <div className="prose prose-invert  max-w-none">
        ...
        {/* ---------------------------------------------------------------- */}
        <section className="mt-10">
          <h2 className="text-xl font-semibold text-fg-light">Technology</h2>
          <div className="mt-4 overflow-hidden rounded-xl border border-edge">
            <table className="w-full text-sm text-left text-fg-secondary">
              <thead className="border-b border-edge bg-card">
                <tr>
                  <th className="px-4 py-3 font-medium text-fg-light">Concern</th>
                  <th className="px-4 py-3 font-medium text-fg-light">Library</th>
                  <th className="px-4 py-3 font-medium text-fg-light">Notes</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-edge">
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-mono text-fg-light">OpenCV.js 4.12 (WASM)</td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-mono text-fg-light">MediaRecorder API</td>
                  <td className="px-4 py-3">WebM output, no ffmpeg needed</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">Framework</td>
                  <td className="px-4 py-3 font-mono text-fg-light">Next.js 16 App Router</td>
                  <td className="px-4 py-3">Client-side processing, server-side API routes</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">Cloud storage</td>
                  <td className="px-4 py-3 font-mono text-fg-light">Amazon S3 (AWS SDK v3)</td>
                  <td className="px-4 py-3">
        ...
        {/* ---------------------------------------------------------------- */}
        <section className="mt-10">
          <h2 className="text-xl font-semibold text-fg-light">Step-by-step guide</h2>
          ...
          <div className="mt-4 flex flex-col gap-4">
            ...
            <div className="rounded-xl border border-edge bg-card px-5 py-4">
              <p className="text-sm font-semibold text-fg-light">2. Choose Indoor or Outdoor</p>
              <p className="mt-1.5 text-sm text-fg-secondary leading-relaxed">
                On the{" "}
                <Link href="/" className="text-fg-light hover:underline">
                  home page
                </Link>{" "}
                select the mode (
            ...
            <div className="rounded-xl border border-edge bg-card px-5 py-4">
              <p className="text-sm font-semibold text-fg-light">3. Upload and process the video</p>
              <p className="mt-1.5 text-sm text-fg-secondary leading-relaxed">
                On the{" "}
                <Link href="/upload" className="text-fg-light hover:underline">
                  Upload page
                </Link>
              ...
              <p className="mt-2 text-sm text-fg-secondary">
                ...
                <code className="text-fg-light">.json</code> file so you can reload it in a
            ...
            <div className="rounded-xl border border-edge bg-card px-5 py-4">
              ...
              <p className="mt-1.5 text-sm text-fg-secondary leading-relaxed">
                On the{" "}
                <Link href="/match" className="text-fg-light hover:underline">
                  Match page
                </Link>
        ...
        <section className="mt-10" id="lighting">
          <h2 className="text-xl font-semibold text-fg-light">Lighting &amp; preprocessing</h2>
          ...
          <div className="mt-4 overflow-hidden rounded-xl border border-edge">
            <table className="w-full text-sm text-left text-fg-secondary">
              <thead className="border-b border-edge bg-card">
                <tr>
                  <th className="px-4 py-3 font-medium text-fg-light">Condition</th>
                  <th className="px-4 py-3 font-medium text-fg-light">Processing applied</th>
                  <th className="px-4 py-3 font-medium text-fg-light">Why</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-edge">
                <tr>
                  <td className="px-4 py-3">Washed out</td>
                  <td className="px-4 py-3 font-mono text-xs text-fg-light">equalizeHist blend (40 %)</td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-mono text-xs text-fg-light">equalizeHist blend (60 %)</td>
        ...
        <section className="mt-10" id="modes">
          <h2 className="text-xl font-semibold text-fg-light">Indoor vs Outdoor mode</h2>
          <p className="mt-3 text-sm text-fg-secondary leading-relaxed">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-edge bg-card px-5 py-4">
              <p className="text-sm font-semibold text-fg-light">Outdoor</p>
              <ul className="mt-2 flex flex-col gap-1.5 pl-4 list-disc text-sm text-fg-secondary">
                <li>
        ...
        <section className="mt-10">
          ...
          <p className="mt-2 text-sm text-fg-secondary leading-relaxed">
            When you click <strong className="text-fg-light">Save to cloud</strong>, only the
            ...
            save runs to your local device as <code className="text-fg-light">.json</code>{" "}
        ...
        <section className="mt-10 mb-12">
          <h2 className="text-xl font-semibold text-fg-light">Troubleshooting</h2>
          <div className="mt-4 flex flex-col gap-3">
            <details className="group rounded-xl border border-edge bg-card">
              <summary className="flex cursor-pointer items-center justify-between px-5 py-3 text-sm font-medium text-fg-light select-none hover:text-fg transition">
        ...
        {/* ---------------------------------------------------------------- */}
        <section className="mt-10 mb-12">
          <h2 className="text-xl font-semibold text-fg-light">Licensing &amp; attribution</h2>
          <div className="mt-4 overflow-hidden rounded-xl border border-edge">
            <table className="w-full text-sm text-left text-fg-secondary">
              <thead className="border-b border-edge bg-card">
                <tr>
                  <th className="px-4 py-3 font-medium text-fg-light">Component</th>
                  <th className="px-4 py-3 font-medium text-fg-light">License</th>
                  <th className="px-4 py-3 font-medium text-fg-light">Copyright</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-edge">
                <tr>
