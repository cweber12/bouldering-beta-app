...
function ComparePageInner() {
  ...
  // ── Phase 1: Setup (before crop confirmed) ──────────────────────────────
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="mx-auto w-full max-w-4xl px-4 py-4 flex flex-col gap-4 sm:px-6">
            ...
            {anyLoaded && (
              <div className={cn(
                "grid gap-3",
                activeSlots === 1 ? "grid-cols-1" : "grid-cols-2",
              )}>
  ...
  // ── Phase 2: Viewing (after crop confirmed) — no-scroll layout ───────────
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
      ...
      {/* Slots + overlay — fills remaining height, scroll if slots overflow */}
