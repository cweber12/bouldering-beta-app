...
export const dark = {
  ...
  handHold:       "#4BE3AC",   // Hand Hold ring — mirror of HOLD_RING_COLOR.hand
  footHold:       "#FFCC29",   // Foot Hold ring — mirror of HOLD_RING_COLOR.foot
} as const;
...
export const light = {
  ...
  handHold:       "#4BE3AC",   // same colours (overlay drawn on a photo, theme-independent)
  footHold:       "#FFCC29",
} as const;
